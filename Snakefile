...
rule make_data_js:
    ...
    run:
        ...
        sn = {"uuid" :"id","qual" :"q","genotype" :"g","Cluster" :"c","Support" :"p","FLSUP" :"flp","FRSUP" :"frp","FSUP" :"fsp","GLeft" :"L","GRight" :"T","GRef" :"R","GLRatio" :"glr","GRRatio" :"gtr","Sample" :"s", "unique_content": "u", "repeat_ranges": "c" }
